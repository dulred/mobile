...
import com.example.ggb.util.MallUtils;
...
@RestController
@Api(value = "v1", tags = "后台管理系统文件上传接口")
...
public class AdminUploadAPI {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file, @TokenToAdminUser AdminUser adminUser) throws URISyntaxException {
    ...
    public Result uploadV2(HttpServletRequest httpServletRequest, @TokenToAdminUser AdminUser adminUser) throws URISyntaxException {
        logger.info("adminUser:{}", adminUser.toString());
