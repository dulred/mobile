...
import com.example.ggb.controller.admin.param.IndexConfigAddParam;
import com.example.ggb.controller.admin.param.IndexConfigEditParam;
...
public class AdminIndexConfigAPI {
    ...
    public Result list(@RequestParam(required = false) @ApiParam(value = "页码") Integer pageNumber,
                       ...
                       @RequestParam(required = false) @ApiParam(value = "1-搜索框热搜 2-搜索下拉框热搜 3-(首页)热销商品 4-(首页)新品上线 5-(首页)为你推荐") Integer configType, @TokenToAdminUser AdminUser adminUser) {
    ...
    public Result save(@RequestBody @Valid IndexConfigAddParam indexConfigAddParam, @TokenToAdminUser AdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
    ...
    public Result update(@RequestBody @Valid IndexConfigEditParam indexConfigEditParam, @TokenToAdminUser AdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
        IndexConfig indexConfig = new IndexConfig();
    ...
    public Result delete(@RequestBody BatchIdParam batchIdParam, @TokenToAdminUser AdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
